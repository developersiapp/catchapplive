  ...
  static getDerivedStateFromProps(props, state) {
    ...
    if (props.userData !== undefined && props.userData !== state.userData) {
      ...
      if (state.rememberMe == true) {
        ...
        localStorage.setItem("session", state.rememberMe);
      }
  ...
  handleSubmit = (event) => {
    ...
    if (isFormSubmit()) {
      ...
      if (
        ...
        this.setState({ userNaam: this.state.email });
        /* error = true;
        this.setState({
      ...
      if (this.state.rememberMe == true) {
        ...
        localStorage.setItem("session", this.state.rememberMe);
      }
      ...
      this.props.djSignInRequest(formData);
    }
  };
              ...
              <section className="login-left-box">
                <div className="login-box-inner">
                  ...
                  <form onSubmit={this.handleSubmit}>
                    ...
                    {/* <span
                    className={
                      this.state.passError ? this.state.passError : "no-display"
                    }
                  >
...
const mapStateToProps = (state) => {
  ...
  if (state.LoginReducer.action === "LOGIN") {
    ...
    return returnState;
  } else if (state.LoginReducer.action === "SOCIAL_LOGIN") {
    if (state.LoginReducer.Logindata.error !== false) {
      returnState.errorData = state.LoginReducer.Logindata;
      returnState.errorDate = new Date();
    } else {
...
const mapDispatchToProps = (dispatch) => {
  return bindActionCreators(
    {
      djSignInRequest: djSignInRequest,
