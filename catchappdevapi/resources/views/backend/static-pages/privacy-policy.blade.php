            ...
            <div class="privacy-policy-content box">
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <h3 class="box-title">{{isset($page)?($page->title!=''?$page->title:'Privacy Policy'):'Privacy Policy'}} </h3>

                        <div class="box-tools pull-right" data-toggle="tooltip">
                            <div class="btn-group" data-toggle="btn-toggle">
                                <button id="edit_policy"
                                        class="btn btn-xs btn-success edit_policy">
                                    <i class="fa fa-file-text "></i><span> {{isset($page)?($page->title!=''?$page->title:'Privacy Policy'):'Privacy Policy'}}</span>
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="box-body"
                        ...
                        <div class="policy" id="policy"
                            ...
                            {!! isset($page)?($page->page_content!='')?$page->page_content:'<span class="text-muted"><i> Add privacy policies first!</i></span>' :'<span class="text-muted"><i> Add privacy policies first!</i></span>' !!}
                        </div>
                        <div class="editor" id="editor" style="display: none;">

                            <form action="{{url('' . env('APP_URL') . '/dashboard/pages/save-privacy-policy')}}"
                                  method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <textarea maxlength="8" class="form-control summernote"
